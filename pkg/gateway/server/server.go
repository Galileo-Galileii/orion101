...
import (
	...
	"github.com/orion101-ai/orion101/pkg/gateway/server/dispatcher"
	"github.com/orion101-ai/orion101/pkg/gateway/types"
...
type Options struct {
	Hostname     string
	UIHostname   string `name:"ui-hostname" env:"ORION101_SERVER_UI_HOSTNAME"`
	GatewayDebug bool
}
