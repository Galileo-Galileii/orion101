...
const steps: OAuthFormStep<typeof schema.shape>[] = [
    ...
    },
    {
        type: "markdown",
        text:
            "### Step 5: Register your OAuth App in Orion101\n" +
            "With the credentials you just created, register your OAuth App in Orion101 by entering the `Client ID` and `Client Secret` into the fields below and clicking on the `Submit` button.",
    },
